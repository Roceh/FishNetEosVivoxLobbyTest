...
{
    /// <summary>
    /// Predication controller for tracked vehicle
    /// </summary>
    [RequireComponent(typeof(TrackedRayVehicle))]
    public class PredictedTrackedRayVehicle : PredictedVehicle
    {        
        private TrackedRayVehicle _vc;
        ...
        private void Awake()
        {
            _vc = GetComponent<TrackedRayVehicle>();
        }
